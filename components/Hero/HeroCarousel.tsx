  ...
  return (
    <section
      ...
      style={{
        ...
        paddingTop: '7rem', // 112px - ensures content doesn't hide behind fixed headers
      }}
    ...
    >
      ...
      <div className="relative z-10 flex items-center min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center pb-16">
            ...
            >
              <div className="relative">
                ...
                <div className="relative w-72 h-72 p-8">
                  <div className="w-full h-full rounded-full overflow-hidden shadow-2xl border-4 border-gold-400/50 bg-white/10 backdrop-blur-sm">
                    <Image
                      src="/images/logo-circular.png"
                      alt="Goldmine Communications and Construction"

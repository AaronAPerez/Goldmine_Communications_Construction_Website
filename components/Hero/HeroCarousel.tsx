 ...
 * - Cleaned up design with better space utilization
 */
...
const heroSlides: HeroSlide[] = [
  ...
  {
    id: 'construction',
    image: '/images/PouringConcrete.jpg',
...
const HeroCarousel = () => {
  ...
  return (
    <section
      ...
      style={{
        // Account for fixed headers - using proper 7rem spacing
        paddingTop: '7rem', // 112px to accommodate contact bar + navigation
      }}
    ...
    >
      ...
      <div className="relative z-10 flex items-center min-h-screen py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          {/* Improved desktop layout - Better grid distribution */}
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 lg:min-h-[70vh] pb-20">
            ...
            >
              ...
              <h1 id="hero-heading" className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-8 leading-tight">
                <AnimatedText
                  text="Building"
              ...
              <motion.p
                ...
                className="text-md sm:text-lg lg:text-xl text-gray-200 mb-12 leading-relaxed max-w-4xl mx-auto lg:mx-0 text-shadow-sm"
              >
              ...
              {/* <AnimatePresence mode="wait">
                ...
                >
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gold-400 text-shadow">
                    {currentSlideData.title}
                  </h2>
                  <h3 className="text-md sm:text-lg lg:text-xl text-gray-200 text-shadow-sm mt-0">
                    {currentSlideData.subtitle}
                  </h3>
                  <p className="text-base sm:text-md lg:text-lg text-gray-100 leading-relaxed max-w-3xl mx-auto md:mx-0 text-shadow-sm">
              ...
              >
                ...
                <motion.a
                  ...
                  className="inline-flex items-center justify-center px-8 py-4 
                           border-2 border-white/80 text-white rounded-lg font-semibold text-lg
              ...
              <motion.div
                ...
                className="flex flex-wrap justify-center lg:justify-start gap-6 max-w-3xl mx-auto lg:mx-0"
              >
                {[
                  { text: '15+ Years Experience', color: 'bg-gold-400' },
                  { text: 'Licensed & Insured #1099543', color: 'bg-gold-400' },
                  { text: 'We Beat Estimates', color: 'bg-gold-400' }
                ].map(({ text, color }) => (
                  <div key={text} className="flex items-center bg-black/30 backdrop-blur-sm rounded-full px-6 py-3 border border-white/10">
                    <div className={`w-2 h-2 ${color} rounded-full mr-3 flex-shrink-0`} />
            ...
            <motion.div
              ...
              className="hidden lg:flex flex-col items-center lg:col-span-5"
            >
      ...
      {/* Carousel Controls - Simplified and better positioned */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center">
            ...
            <div className="flex items-center space-x-3 mr-8">
              <button
                onClick={prevSlide}
                className="p-2.5 rounded-full bg-white/10 border border-white/20 

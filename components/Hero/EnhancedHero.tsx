...
export default function EnhancedHero() {
  ...
  return (
    <section className="relative min-h-[100vh] w-full overflow-hidden" aria-label="Hero Banner">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                ...
                className="px-6 sm:px-8 py-3 bg-gold-400 text-white rounded-lg font-medium 
                       hover:bg-gold-500 transition-colors duration-200 inline-flex items-center"
              >
                Get a Free Quote
              </Link>
            </motion.div>
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                ...
                className="px-6 sm:px-8 py-3 border-2 bg-black/40 border-white text-white rounded-lg 
                       font-medium hover:bg-white/10 transition-colors duration-200 inline-flex items-center"
              >
                Our Services
              </Link>
            </motion.div>
